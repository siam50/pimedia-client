...
const PostCard = ({ post }) => {
    ...
    const handleLike = () => {
        ...
        //     fetch(`https://y-mauve-chi.vercel.app/posts/${_id}`, {
        //         method: "PUT",
    ...
    return (
        <div className="rounded-md shadow-md sm:w-96 bg-gray-900 text-gray-100 my-10">
            ...
            <div className="p-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        <button onClick={handleLike} type="button" title="Like post" className={`flex items-center justify-center ${role && " bg-red-500"}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
