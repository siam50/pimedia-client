            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                    <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                        ...
                        <p class="mt-2 text-base text-gray-600">Don’t have an account? <Link to={'/signup'} class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Create a free account</Link></p>

                        <form onSubmit={handleLogin} action="#" method="POST" class="mt-8">
                            <div class="space-y-5">
                                <div>
